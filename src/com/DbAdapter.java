...
public class DbAdapter {
    ...
    public synchronized boolean addNewPage(String url, String title, String h1, String h2, String h3, String h4, String h5, String h6, String body, String alt, String meta, int date) {
        try {
            ...
            String query = "INSERT INTO `pages` (`id`, `url`, `title`, `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `body`, `alt`, `meta`, `date`, `indexed`) VALUES (NULL,? ,? ,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
